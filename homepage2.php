...
<script src="getname.js" type="text/javascript"></script>
...
<li><a href="moreschedule.php" class="topnav topnav-schedule ">schedule</a></li>
				
<li><a href="morenews.php" class="topnav topnav-news ">news</a></li>
    ...
    <div class="rightwidebox">
		...
		<h1><div class="title"><img src="images/schedule-title.gif" alt="" /></div></h1>
				...
				<div class="boxgeneral" style="width:270px;">
					...
					<div class="baselink clearfloat" style="width:100%;_width:97%; border:none;">
						<span style="float:right;margin-right:8px;"><a href="morenews.php">more news</a></span>
					</div>
					</div>
					<div class="innerboxbase-small"></div>
				</div><!--boxgeneral-->
