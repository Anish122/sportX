...
function show()
{
document.getElementById('imgmain').src="Image/cricket1.png";
...
function show1()
{
document.getElementById('imgmain').src="Image/cricket2.png";
...
function show2()
{
document.getElementById('imgmain').src="Image/football1.png";
...
function show3()
{
document.getElementById('imgmain').src="Image/formula11.png";
...
function show4()
{
document.getElementById('imgmain').src="Image/formula12.png";
...
<body onLoad="show()">
    ...
    <tr>
    <td class="style3">
    <img id="imgmain" style="border: medium solid #000000; height: 270px; width: 610px" 
           />
    </td>
    </tr>
    
    <tr>
    <td class="style2" style="position:relative; top:-30px;">
