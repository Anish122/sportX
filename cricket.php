	...
	<div id="midcontent">
		<div id="leftcontent">
			...
			<div class="leftwidebox">
				...
				<select name="country" id="country"  onchange="showCountry(this.value)">
				...
				<div class="boxgeneral" style="width:628px;">
					<div class="flashslideshow">
                     <div><b>Select on the country and player name will be listed here.</b></div>
                 
               <div id="showme" style="color:#7a7a7a;"></div>
               
               <div id="showmeinfo"></div>
    ...
    <div class="rightwidebox">
		...
		<h1><div class="title"><img src="images/schedule-title.gif" alt="" /></div></h1>
				...
				<div class="boxgeneral" style="width:270px;">
					...
					<div class="baselink clearfloat" style="width:100%;_width:97%; border:none;">
						<span style="float:right;margin-right:8px;"><a href="morecnews.php">more news</a></span>
					</div>
					</div>
					<div class="innerboxbase-small"></div>
				</div><!--boxgeneral-->
