...
<li><a href="loginf.php" class="topnav topnav-schedule ">schedule</a></li>
				
<li><a href="loginf.php" class="topnav topnav-news ">news</a></li>
				<li><a href="loginf.php" class="topnav topnav-videos ">videos</a></li>
                <li><a href="loginf.php" class="topnav topnav-aboutus ">Sports</a>
					<ul>
                      <li><a href="loginf.php">Cricket</a></li>
              <li><a href="loginf.php">Football</a></li>
 <li><a href="loginf.php">Formula 1</a></li>
					</ul>
        </li>
 ...
 <li><a href="meetus.php">Meet Us</a></li>
	...
	<div id="midcontent">
		<div id="leftcontent">
          ...
          <embed id="showslideshow" width="630" height="324" src="demo_1/index.php" wmode="transparent" bgcolor="" ></embed> 
