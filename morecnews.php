...
<script src="cplayer.js" type="text/javascript"></script>
<script src="playerinfo.js" type="text/javascript"></script>
<script src="cplayer.js" type="text/javascript"></script>
<script src="cplayerinfo.js" type="text/javascript"></script>
...
<script src="showcri.js" type="text/javascript"></script>
...
<li><a href="morecschedule.php" class="topnav topnav-schedule ">schedule</a></li>
				
<li><a href="morecnews.php" class="topnav topnav-news ">news</a></li>
	...
	<div id="midcontent">
		<div id="leftcontent">
			...
			<div class="leftwidebox">
				...
				<h1><div class="title"><img src="images/news-title.gif" alt="" /></div></h1>
				<div class="boxgeneral" style="width:627px; height:770px">
				<div class="innerbox clearfix" style="height:765px">
...
<li style="margin-top:10px;"><img src="images/cal-arrowright.gif" alt="" onClick="nextdayDate()" /></li>
					...
					<!--schedule chunk -->
                        ...
                        <div id="showmorecnews"></div>  
                                
                                
										
							<div class="pagination-bg clear">
						<div class="pagination1" style="float:right;margin-right:8px;"><span>&laquo;</span>
				...
				<div class="rightHPad" style="text-align: center">
				</div>				
    ...
    <div class="rightwidebox">
		...
		<h1><div class="title"><img src="images/schedule-title.gif" alt="" /></div></h1>
				...
				<div id="showschedule"></div>
						...
						<span style="float:right;margin-right:8px;"><a href="morecschedule.php">full tv schedule</a></span>
					</div>
					</div>
				...
				<div class="boxgeneral" style="width:270px;">
					<div class="innerbox-small clearfix" style="text-align:center; padding-top:7px;">
                       ...
                       <div style="border-style: dotted;border-width: 0;border-color: #2858FF;overflow: visible;"><div id="newsblock53191005" style="word-wrap: break-word; padding: 5px; background-color: #C7C7C7;">
...
<script id="scrnewsblock53191005" type="text/javascript"></script>
<script type="text/javascript"> /* <![CDATA[ */ 
setTimeout('document.getElementById(\'scrnewsblock53191005\').src = (document.location.protocol == \'https:\' ? \'https\' : \'http\') + \'://www.poweringnews.com/newsjavascript.aspx?feedurl=http%3A//static.cricinfo.com/rss/livescores.xml&maxitems=5&showfeedtitle=0&showtitle=1&showdate=1&showsummary=0&showauthor=0&showactionsbox=0&showrsslink=0&showcopyright=0&opennewwindow=0&inheritstyles=0&bgcolor=%23C7C7C7&titlefontsize=10&summaryfontsize=8&fontfamily=Arial%2CHelvetica&titlecolor=%23190000&summarycolor=%231F0005&sepstyle=dotted&sepcolor=%23DFDFDF&objectid=newsblock53191005\'', 500);
 /* ]]> */ </script>
