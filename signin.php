...
function validate()
{
	if( document.myform.element_1_1.value == "" )
   {
     ...
     document.myform.element_1_1.focus() ;
     return false;
   }
   if( document.myform.element_1_2.value == "" )
   {
     alert( "Please provide your last name!" );
     document.myform.element_1_2.focus() ;
     return false;
   }
   var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
   var address = document.myform.element_2.value;
   if(reg.test(address) == false) 
    {
 
      alert( "Please provide your valid Email id!" );
     document.myform.element_2.focus() ;
     return false;
   }
   if( document.myform.element_3_1.value == "" )
   {
     alert( "Please provide your date of birth!" );
     document.myform.element_3_1.focus() ;
     return false;
   }
   if( document.myform.element_3_2.value == "" )
   {
     alert( "Please provide your month of birth!" );
     document.myform.element_3_2.focus() ;
     return false;
   }
   if( document.myform.element_3_3.value == "" )
   {
     alert( "Please provide your year of birth!" );
     document.myform.element_3_3.focus() ;
     return false;
   }
   if( document.myform.element_6.value == "" )
   {
     alert( "Please provide your gender" );
     document.myform.element_6.focus() ;
     return false;
   }
    var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
   var address = document.myform.element_4.value;
   if(reg.test(address) == false) 
    {
 
      alert( "Please provide your current Email id!" );
     document.myform.element_4.focus() ;
     return false;
   }
   var reg1 = /^([A-Za-z])$/;
   if( document.myform.element_5.value == "" )
   {
     alert( "Please provide your valid Location" );
     document.myform.element_5.focus() ;
     return false;
   }
...
<form name="myform" onsubmit="return(validate());" method="post">	
	...
	<div id="form_container">
		...
		<h1><a>Create Your Account</a></h1>
		<form id="form_488778" class="appnitro"  method="post">
		...
		<label class="description" for="element_2">Choose your email id </label>(This will be your user name)
		<div>
		...
		<label class="description" for="element_6">Gender </label>
		<div>
...
<option value="4" >Other</option>
		...
		<label class="description" for="element_4">Your Current Email Id </label>
		<div>
		...
		<div>
			<input id="element_5" name="element_5" class="element text medium" type="text" maxlength="255" value=""/> 
					...
					<li class="buttons">
			    <input type="hidden" name="form_id" value="488778" />
